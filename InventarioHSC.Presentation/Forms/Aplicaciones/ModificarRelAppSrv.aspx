<%@ Page Title="Modificar relaciones entre aplicación y servidores" Language="C#" MasterPageFile="~/Forms/Main.Master" AutoEventWireup="true"
    CodeBehind="ModificarRelAppSrv.aspx.cs" Inherits="InventarioHSC.Forms.Aplicaciones.ModificarRelAppSrv" %>
    ...
    <div id="contenidoLogueado2" runat="server" style="height: 540px">
        ...
        <div class="MainDiv">
            <div class="CeldaImagenAzul">
                .: MODIFICAR RELACIONES ENTRE APLICACIÓN Y SERVIDORES :.
            </div>
            <br />
            <div style="width: 410px;">
                ...
                <div style="border: medium ridge #ffffff; width: 410px;">
                    <asp:Panel ID="pnlRel" runat="server" DefaultButton="btnProcesarD" Enabled="False">
                        Puede agregar o eliminar la relación con un servidor.
                        <br />
                        <br />
                        <div style="height: 110px; background-color: rgba(73,114,158,0.5); text-align: left;">
                            ...
                            <div style="width: 410px;">
                                ...
                                <div style="width: 325px; float: right; text-align: left;">
                                    &nbsp
                                    <asp:DropDownList ID="ddlServidores" runat="server" Width="202">
                                    </asp:DropDownList>
                                </div>
                            </div>
                            <br />
                        ...
                        <asp:GridView ID="grdDatos" runat="server" Width="300px" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                <asp:BoundField HeaderText="Servidor" DataField="Srv_Nombre">
                                ...
                                <asp:BoundField DataField="Srv_Id" HeaderText="" HeaderStyle-CssClass="GridColumnHide"
                                    ItemStyle-CssClass="GridColumnHide">
                                    <HeaderStyle Width="1px" />
                                    <ItemStyle Width="1px" />
                                </asp:BoundField>
