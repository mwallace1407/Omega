...
{
    public partial class MensajeA : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                if (Request.QueryString["Archivo"] != null && Request.QueryString["Archivo"].ToString() != "")
                {
                    lnkArchivo.NavigateUrl = InventarioHSC.Model.DatosGenerales.RutaReportesDinamicos + HttpContext.Current.Server.UrlDecode(Request.QueryString["Archivo"].ToString());
                }
                else
                {
