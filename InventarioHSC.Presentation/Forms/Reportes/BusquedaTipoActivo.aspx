<%@ Page Title="" Language="C#" MasterPageFile="~/Forms/Sitio.Master" AutoEventWireup="true"
    CodeBehind="BusquedaTipoActivo.aspx.cs" Inherits="InventarioHSC.Forms.Reportes.BusquedaTipoActivo" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Panel ID="pnlFiltros" runat="server" Width="100%">
        <div style="background-color: #DAE7F6; border-color: #005DAA; border-style: inherit;
            width: 99%;">
        ...
        <div>
            <asp:GridView ID="gvGeneral" runat="server" Width="80%" Font-Size="Small" HorizontalAlign="Center"
                AutoGenerateColumns="False" EnableModelValidation="True" AllowPaging="True" BorderColor="#005DAA"
                ...
                <HeaderStyle BackColor="#005DAA" Font-Bold="True" Font-Size="Small" Font-Strikeout="False"
                    ForeColor="White" />
