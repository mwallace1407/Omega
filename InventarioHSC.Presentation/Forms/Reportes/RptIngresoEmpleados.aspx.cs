...
{
    public partial class RptIngresoEmpleados : System.Web.UI.Page
    {
        ...
        protected System.Data.DataTable Fijos()
        {
            ...
            string[] Archivos = System.IO.Directory.GetFiles(Server.MapPath("Fijos"), "IngresoEmpleados_*.xlsx");
            System.Data.DataRow dr;

            foreach (string a in Archivos)
            {
                dr = Res.NewRow();
                dr[0] = System.IO.Path.GetFileNameWithoutExtension(a).Replace("IngresoEmpleados_", "");
        ...
        protected void btnProcesar_Click(object sender, EventArgs e)
        {
            ...
            //grdDatosF.DataSource = rep.IngresoEmpleados(ArmadoCadena(chkEmpleados),
            ...
            exportar.IngresoEmpleados((int)DatosGenerales.TiposDocumentos.Reporte_IngresoEmpleados, Session["UserNameLogin"].ToString(), Server.MapPath(DatosGenerales.RutaLocalReportesDinamicos), DatosGenerales.GeneraNombreArchivoRnd("RptWSIngEmp_", "xlsx"), 250000,
