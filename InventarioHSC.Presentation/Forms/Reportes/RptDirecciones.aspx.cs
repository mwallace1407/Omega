...
{
    public partial class RptDirecciones : System.Web.UI.Page
    {
        ...
        protected System.Data.DataTable Fijos()
        {
            ...
            string[] Archivos = System.IO.Directory.GetFiles(Server.MapPath("Fijos"), "Direcciones_*.xlsx");
            System.Data.DataRow dr;

            foreach (string a in Archivos)
            {
                dr = Res.NewRow();
                dr[0] = System.IO.Path.GetFileNameWithoutExtension(a).Replace("Direcciones_", "");
        ...
        protected void btnProcesar_Click(object sender, EventArgs e)
        {
            ...
            //grdDatosF.DataSource = rep.Direcciones(ArmadoCadena(chkEmpleados),
            ...
            exportar.Direcciones((int)DatosGenerales.TiposDocumentos.Reporte_Direcciones, Session["UserNameLogin"].ToString(), Server.MapPath(DatosGenerales.RutaLocalReportesDinamicos), DatosGenerales.GeneraNombreArchivoRnd("RptWSDir_", "xlsx"), 250000,
