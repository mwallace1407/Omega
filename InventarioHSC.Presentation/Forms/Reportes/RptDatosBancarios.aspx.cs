...
{
    public partial class RptDatosBancarios : System.Web.UI.Page
    {
        ...
        protected System.Data.DataTable Fijos()
        {
            ...
            string[] Archivos = System.IO.Directory.GetFiles(Server.MapPath("Fijos"), "DatosBancarios_*.xlsx");
            System.Data.DataRow dr;

            foreach (string a in Archivos)
            {
                dr = Res.NewRow();
                dr[0] = System.IO.Path.GetFileNameWithoutExtension(a).Replace("DatosBancarios_", "");
        ...
        protected void btnProcesar_Click(object sender, EventArgs e)
        {
            ...
            //grdDatosF.DataSource = rep.DatosBancarios(ArmadoCadena(chkEmpleados),
            ...
            exportar.DatosBancarios((int)DatosGenerales.TiposDocumentos.Reporte_DatosBancarios, Session["UserNameLogin"].ToString(), Server.MapPath(DatosGenerales.RutaLocalReportesDinamicos), DatosGenerales.GeneraNombreArchivoRnd("RptWSDatBan_", "xlsx"), 250000,
