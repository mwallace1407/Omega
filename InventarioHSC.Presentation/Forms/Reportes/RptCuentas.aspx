<%@ Page Title="Reporte de cuentas" Language="C#" MasterPageFile="~/Forms/Main.Master"
    AutoEventWireup="true" CodeBehind="RptCuentas.aspx.cs" Inherits="InventarioHSC.Forms.Reportes.RptCuentas"
                ...
                <ContentTemplate>
                    <div style="width: 200px; text-align: left;">
                        <asp:Panel ID="pnlOpciones" runat="server">
                            <asp:RadioButton ID="rbSociedades" runat="server" GroupName="rbOpciones" Text="Reporte con filtro por sociedad"
                                AutoPostBack="True" Checked="True" OnCheckedChanged="rbSociedades_CheckedChanged" />
                            <br />
                    ...
                    <asp:Panel ID="pnlAnual" runat="server" Visible="True">
                        <div style="width: 380px; text-align: left;">
                            <asp:GridView ID="grdDatos" runat="server" Width="320px" AutoGenerateColumns="False"
                                OnRowDataBound="grdDatos_RowDataBound" OnPageIndexChanging="grdDatos_PageIndexChanging"
                                ForeColor="#333333" GridLines="None" AllowPaging="True">
                                <Columns>
                                    <asp:BoundField HeaderText="Año" DataField="Sociedad">
                    ...
                    <asp:Panel ID="pnlFiltros" runat="server" Visible="False">
                        <div style="width: 820px; height: 100px;">
                                ...
                                <div style="width: 360px; height: 100px;">
                                    ...
                                    <div style="width: 275px; float: right; text-align: left;">
                                        <div style="border: 3px ridge SteelBlue; height: 100px; overflow: scroll; overflow-x: hidden;">
                                            <asp:CheckBoxList ID="chkCuentas" runat="server" Width="250" AutoPostBack="True"
                                                OnSelectedIndexChanged="chkCuentas_SelectedIndexChanged">
                                            </asp:CheckBoxList>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div style="width: 410px; float: right; text-align: left;">
                                <div style="width: 360px; height: 100px;">
                                    ...
                                    <div style="width: 275px; float: right; text-align: left;">
                                        <div style="border: 3px ridge SteelBlue; height: 100px; overflow: scroll; overflow-x: hidden;">
                                            <asp:CheckBoxList ID="chkSociedades" runat="server" Width="250" AutoPostBack="True"
                                                OnSelectedIndexChanged="chkSociedades_SelectedIndexChanged">
                                            </asp:CheckBoxList>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <br />
                        <div style="width: 200px; text-align: left;">
                            <asp:GridView ID="grdDatosF" runat="server" Width="200px" AutoGenerateColumns="False"
