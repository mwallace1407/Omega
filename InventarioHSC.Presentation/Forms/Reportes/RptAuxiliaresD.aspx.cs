...
{
    public partial class RptAuxiliaresD : System.Web.UI.Page
    {
        ...
        protected void CargaCatalogos()
        {
            ...
            objCatalogo.CatalogoEjerciciosCHK(ref chkAnios, (int)DatosGenerales.ReportesSAP.Auxiliares_Detalle);
            chkAnios.DataBind();

            objCatalogo.CatalogoSociedadesCHK(ref chkSociedades, (int)DatosGenerales.ReportesSAP.Auxiliares_Detalle);
        ...
        protected System.Data.DataTable Fijos()
        {
            ...
            string[] Archivos = System.IO.Directory.GetFiles(Server.MapPath("Fijos"), "AuxiliaresD_*.xlsx");
            System.Data.DataRow dr;

            foreach (string a in Archivos)
            {
                dr = Res.NewRow();
                dr[0] = System.IO.Path.GetFileNameWithoutExtension(a).Replace("AuxiliaresD_", "");
        ...
        protected void btnProcesar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    //grdDatosF.DataSource = rep.AuxiliaresDetalle(ArmadoCadena(chkSociedades),
                    ...
                    exportar.AuxiliaresDetalle((int)DatosGenerales.TiposDocumentos.Reporte_DetalleAuxiliaresContables, Session["UserNameLogin"].ToString(), Server.MapPath(DatosGenerales.RutaLocalReportesDinamicos), DatosGenerales.GeneraNombreArchivoRnd("RptWSAuxDetCont_", "xlsx"), 250000,
