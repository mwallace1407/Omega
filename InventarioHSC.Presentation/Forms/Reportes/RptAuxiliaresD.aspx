<%@ Page Title="Reporte para detalle de auxiliares" Language="C#" MasterPageFile="~/Forms/Main.Master"
    AutoEventWireup="true" CodeBehind="RptAuxiliaresD.aspx.cs" Inherits="InventarioHSC.Forms.Reportes.RptAuxiliaresD"
    ...
    <div id="contenidoLogueado2" runat="server" style="height: 470px">
        ...
        <div class="MainDiv">
            <div class="CeldaImagenAzul">
                .: REPORTE PARA DETALLE DE AUXILIARES :.
            </div>
            <br />
                                ...
                                <div style="width: 360px; height: 100px;">
                                    ...
                                    <div style="width: 275px; float: right; text-align: left;">
                                        <div style="border: 3px ridge SteelBlue; height: 100px; overflow: scroll; overflow-x: hidden;">
                                            <asp:CheckBoxList ID="chkAnios" runat="server" Width="250" OnSelectedIndexChanged="chkAnios_SelectedIndexChanged"
                                                AutoPostBack="True">
                                            </asp:CheckBoxList>
                                        </div>
                                    </div>
