...
{
    public partial class RptMedidas : System.Web.UI.Page
    {
        ...
        protected System.Data.DataTable Fijos()
        {
            ...
            string[] Archivos = System.IO.Directory.GetFiles(Server.MapPath("Fijos"), "Medidas_*.xlsx");
            System.Data.DataRow dr;

            foreach (string a in Archivos)
            {
                dr = Res.NewRow();
                dr[0] = System.IO.Path.GetFileNameWithoutExtension(a).Replace("Medidas_", "");
        ...
        protected void btnProcesar_Click(object sender, EventArgs e)
        {
            ...
            //grdDatosF.DataSource = rep.Medidas(ArmadoCadena(chkEmpleados),
            ...
            exportar.MedidasRH((int)DatosGenerales.TiposDocumentos.Reporte_MedidasRH, Session["UserNameLogin"].ToString(), Server.MapPath(DatosGenerales.RutaLocalReportesDinamicos), DatosGenerales.GeneraNombreArchivoRnd("RptWSMedRH_", "xlsx"), 250000,
