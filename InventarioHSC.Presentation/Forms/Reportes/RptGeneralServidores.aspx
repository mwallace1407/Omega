<%@ Page Language="C#" MasterPageFile="~/Forms/Main.Master" AutoEventWireup="true"
    Title="Reporte General de Servidores" CodeBehind="RptGeneralServidores.aspx.cs"
    Inherits="InventarioHSC.Forms.Reportes.RptGeneralServidores" %>
    ...
    <div id="contenidoLogueado2" runat="server" style="height: 465px">
        ...
        <div class="MainDiv">
            <div class="CeldaImagenAzul">
                .: REPORTE PARA EL INVENTARIO DE SERVIDORES :.
            </div>
            <br />
            <div style="width: 830px; height: 105px;">
                <div style="width: 410px; height: 100px; float: left;">
                    ...
                    <div style="width: 275px; float: right; text-align: left;">
                        <div style="border: 3px ridge SteelBlue; height: 100px; overflow: scroll; overflow-x: hidden;">
                            <asp:CheckBoxList ID="chklEquipos" runat="server" Width="250">
                            </asp:CheckBoxList>
                        </div>
                    </div>
                </div>
                <div style="width: 410px; height: 100px; float: right;">
                    ...
                    <div style="width: 275px; float: right; text-align: left;">
                        <div style="border: 3px ridge SteelBlue; height: 100px; overflow: scroll; overflow-x: hidden;">
                            <asp:CheckBoxList ID="chklSO" runat="server" Width="250">
                            </asp:CheckBoxList>
                        </div>
                    </div>
                </div>
            ...
            <div style="width: 410px; height: 30px;">
                ...
                <div style="width: 275px; float: right; text-align: center;">
                    <asp:DropDownList ID="ddlEsVirtual" runat="server" Width="275px">
                    </asp:DropDownList>
                </div>
            </div>
            <br />
            <div style="width: 410px; height: 30px;">
                ...
                <div style="width: 275px; float: right; text-align: center;">
                    <asp:DropDownList ID="ddlEstado" runat="server" Width="275px">
                    </asp:DropDownList>
                </div>
            </div>
            <br />
