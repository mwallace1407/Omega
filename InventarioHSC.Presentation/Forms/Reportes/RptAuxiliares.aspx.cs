...
{
    public partial class RptAuxiliares : System.Web.UI.Page
    {
        ...
        protected System.Data.DataTable Fijos()
        {
            ...
            string[] Archivos = System.IO.Directory.GetFiles(Server.MapPath("Fijos"), "Auxiliares_*.xlsx");
            System.Data.DataRow dr;

            foreach (string a in Archivos)
            {
                dr = Res.NewRow();
                dr[0] = System.IO.Path.GetFileNameWithoutExtension(a).Replace("Auxiliares_", "");
        ...
        protected void btnProcesar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    //grdDatosF.DataSource = rep.Auxiliares(ArmadoCadena(chkSociedades),
                    ...
                    exportar.AuxiliaresContables((int)DatosGenerales.TiposDocumentos.Reporte_AuxiliaresContables, Session["UserNameLogin"].ToString(), Server.MapPath(DatosGenerales.RutaLocalReportesDinamicos), DatosGenerales.GeneraNombreArchivoRnd("RptWSAuxCont_", "xlsx"), 250000,
