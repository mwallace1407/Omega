<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MensajeA.aspx.cs" Inherits="InventarioHSC.Forms.MensajeA" ValidateRequest="false" %>
        ...
        <div style="text-align: center; width: 800px; margin-left: auto; margin-right: auto;">
            ...
            <div style="text-align: left;" class="divRoundedOpacity">
                ...
                <div style="padding-left: 10px">
                    ...
                    <br />
                    <br />
                    <asp:Label ID="lblArchivo" runat="server" Text="Archivo resultado:" Font-Bold="True"></asp:Label>
                    <br />
                    <asp:HyperLink ID="lnkArchivo" runat="server">Descargar</asp:HyperLink>
                    <br />
                    <br />
                </div>
                <div style="text-align: center">
