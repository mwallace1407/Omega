<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CatalogoPuesto.aspx.cs"
    Inherits="InventarioHSC.CatalogoPuesto" EnableEventValidation="false" Title="Catálogo de Puestos"
        ...
        <div class="MainDiv" id="space">
            ...
            <div style="text-align: left; width: 500px;">
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        <asp:GridView ID="gwvPuesto" runat="server" AutoGenerateColumns="False" DataKeyNames="idPuesto"
                            Width="90%" EmptyDataText="No existe Informacion" OnRowCommand="gwvPuesto_RowCommand"
                            OnRowDataBound="gwvPuesto_RowDataBound" AllowPaging="true" OnPageIndexChanging="gwvPuesto_PageIndexChanging"
                            PageSize="15">
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="idPuesto" HeaderText="ID" SortExpression="idPuesto" />
