<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CatalogoUsuario.aspx.cs"
    Inherits="InventarioHSC.CatalogoUsuario" EnableEventValidation="false" Title="Catálogo de usuarios en plantilla"
        ...
        <div class="MainDiv" id="space">
            ...
            <div class="MainDiv" style="text-align: left; height: 35px">
                <div style="width: 475px;">
                    ...
                    <div style="width: 400px; float: right">
                        <asp:DropDownList ID="ddlPuesto" runat="server" Height="22px" Width="312px">
                        </asp:DropDownList>
            ...
            <div style="text-align: left; width: 500px;">
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        <asp:GridView ID="gwvUsuario" runat="server" AutoGenerateColumns="False" DataKeyNames="idUsuario"
                            Width="90%" EmptyDataText="No existe Informacion" OnRowCommand="gwvUsuario_RowCommand"
                            OnRowDataBound="gwvUsuario_RowDataBound" AllowPaging="true" OnPageIndexChanging="gwvUsuario_PageIndexChanging"
                            PageSize="15">
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="puestoDesc" HeaderText="Puesto" SortExpression="puestoDesc" />
                            </Columns>
                        </asp:GridView>
                    </ContentTemplate>
                </asp:UpdatePanel>
