<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CatalogoRegion.aspx.cs"
    Inherits="InventarioHSC.CatalogoRegion" EnableEventValidation="false" Title="Catálogo de Regiones"
        ...
        <div class="MainDiv" id="space">
            ...
            <div style="text-align: left; width: 500px;">
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        <asp:GridView ID="gwvRegion" runat="server" AutoGenerateColumns="False" DataKeyNames="idRegion"
                            Width="90%" EmptyDataText="No existe Informacion" OnRowCommand="gwvRegion_RowCommand"
                            OnRowDataBound="gwvRegion_RowDataBound" AllowPaging="true" OnPageIndexChanging="gwvRegion_PageIndexChanging"
                            PageSize="15">
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="idRegion" HeaderText="ID" SortExpression="idRegion" />
