<%@ Control Language="c#" AutoEventWireup="True" CodeBehind="bnrGeneral.ascx.cs"
    Inherits="InventarioHSC.Presentacion.General.bnrGeneral" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
...
<div id="top">
    <table cellspacing="0" cellpadding="0" border="0" width="100%">
        <tr>
            <td width="220">
                <img alt="Logo" src="~/App_Themes/Imagenes/logo_horizontal.png" border="0" runat="server" />
            </td>
            <td>
                <h3>
                    Sistema de Administración de Inmuebles.</h3>
                <p>
                    Bienvenido:
