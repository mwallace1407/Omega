<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CreacionUsuario.aspx.cs" Inherits="InventarioHSC.Forms.Administracion.CreacionUsuario" %>
                        ...
                        <asp:Literal ID="ErrorMessage" runat="server"></asp:Literal>
                         ...
                         ValidationGroup="RegisterUserValidationGroup"/>--%>
                                <div class="accountInfo">
                                    ...
                                    <p>
                                        <center>
                                            <asp:Button ID="CreateUserButton" CssClass="ui-corner-all ui-state-default cancel" runat="server"  CommandName="MoveNext" Text="Crear Usuario"
                                                ValidationGroup="RegisterUserValidationGroup" />
                                        </center>
                                    </p>
                                </div>
