<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConsultaGeneral.aspx.cs"  Inherits="InventarioHSC.ConsultaGeneral" EnableEventValidation="false" %>
...
<head runat="server">
    ...
    <link href="../../App_Themes/Estilos/Redmon/jquery-ui-1.7.2.custom.css" rel="stylesheet" type="text/css" />
...
<body MS_POSITIONING="GridLayout" method="post">
    ...
    <div id="DivPrincipal" style="width:90%; margin-left:100px; margin-top:40px; position:static; top: 109px; left: -7px; height: 899px;">   
       <div id="divitulos" class="ui-corner-all ui-widget ui-widget-content"> 
       <table id="TableTitulos" cellspacing="1" cellpadding="1" width="90%" align="center" border="0" runat="server">
            <tr>
                <td> 
                    <br /> 
                    <br />
            ...
            <tr>
	            <td class="CeldaTituloE" style="HEIGHT: 20px" colspan="2">.::Monitor de Búsqueda de Artículos::.</td>
            </tr>
	    </table>
        <br />
        <div class="ui-state-error" id="Warning" runat="server"><span class="ui-icon ui-icon-alert" style="FLOAT: left"></span><strong><asp:label id="LabelWarning" runat="server" Text=""></asp:label></strong></div>
        <div class="ui-state-highlight" id="Info" runat="server"><span class="ui-icon ui-icon-info" style="FLOAT: left"></span><strong><asp:label id="LabelInfo" runat="server" Text=""></asp:label></strong></div>
        <br />
           <asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server">
           </asp:ToolkitScriptManager>
          <table width="90%" cellspacing="1" cellpadding="1" id="TPrincipal">
                <tr>
					<td class="CeldaDetalleNota" style="HEIGHT: 23px" align="center" colSpan="4"><FONT color="red">Nota:&nbsp;&nbsp;</FONT>Esta 
						marca indica que los campos (<FONT color="red">*</FONT>) son requeridos</td>
				</tr>
				<tr>
				...
				<tr>
				    <td colspan="2" align="center">
                        <asp:GridView ID="gvwReporteGeneral" runat="server"
                            AutoGenerateColumns="false" DataKeyNames="id" Width="90%" 
                            EmptyDataText="No existe Informacion" AllowPaging="True"
                            onpageindexchanging="gvwReporteGeneral_PageIndexChanging" PageSize="20" >
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="noSerie" HeaderText="Serie" 
                                    SortExpression="noSerie"/>
                                <asp:BoundField DataField="idTipoEquipo" HeaderText="idTipoEquipo" 
                                    SortExpression="idTipoEquipo"/>
                                ...
                                <asp:BoundField DataField="idMarca" HeaderText="idMarca" 
                                    SortExpression="idMarca"/>
                                <asp:BoundField DataField="marca" HeaderText="Marca" 
                                    SortExpression="marca"/>
                                <asp:BoundField DataField="modelo" HeaderText="Modelo" 
                                    SortExpression="modelo"/>
                                <asp:BoundField DataField="procesador" HeaderText="Procesador" 
                                    SortExpression="procesador"/>
                                <asp:BoundField DataField="rAM" HeaderText="RAM" 
                                    SortExpression="rAM"/>
                                <asp:BoundField DataField="discoDuro" HeaderText="Disco Duro" 
                                    SortExpression="discoDuro"/>
                                <asp:BoundField DataField="idSistema" HeaderText="idSistema" 
                                    SortExpression="idSistema"/>
                                <asp:BoundField DataField="sistemaOperativo" HeaderText="Sistema Operativo" 
                                    SortExpression="sistemaOperativo"/>
                                ...
                                <asp:BoundField DataField="responsiva" HeaderText="Responsiva" 
                                    SortExpression="responsiva"/>
                                <asp:BoundField DataField="ValorPesos" HeaderText="Valor (Pesos)" 
                                    SortExpression="ValorPesos"/>
                                <asp:BoundField DataField="ValorUSD" HeaderText="Valor (USD)" 
                                    SortExpression="ValorUSD"/>
                                <asp:BoundField DataField="stock" HeaderText="Stock" 
                                    SortExpression="stock"/>
                                <asp:BoundField DataField="codigoCastor" HeaderText="Codigo de Castor" 
                                    SortExpression="codigoCastor"/>
                                <asp:BoundField DataField="idUsuario" HeaderText="idUsuario" 
                                    SortExpression="idUsuario"/>
                                <asp:BoundField DataField="usuarioAsignado" HeaderText="Usuario Asignado" 
                                    SortExpression="usuarioAsignado"/>
                                <asp:BoundField DataField="idUbicacion" HeaderText="idUbicacion" 
                                    SortExpression="idUbicacion"/>
                                ...
                                <asp:BoundField DataField="observacion1" HeaderText="Observacion 1" 
                                    SortExpression="observacion1"/>
                                <asp:BoundField DataField="observacion2" HeaderText="Observación 2" 
                                    SortExpression="observacion2"/>
                                <asp:BoundField DataField="observacion3" HeaderText="Observacion 3" 
                                    SortExpression="observacion3"/>
                                <asp:BoundField DataField="posibleFaltanteFlag" HeaderText="Posible Faltante" 
                                    SortExpression="posibleFaltanteFlag"/>
                                <asp:BoundField DataField="cambioRYS" HeaderText="cambio RYS" 
                                    SortExpression="cambioRYS"/>
                                <asp:BoundField DataField="fechaMovimiento" HeaderText="Fecha Movimiento" 
                                    SortExpression="fechaMovimiento"/>
