<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EntregaEquipo.aspx.cs" Inherits="InventarioHSC.EntregaEquipo" EnableEventValidation="false"%>
...
<head id="Head1" runat="server">
    ...
    <link href="../../App_Themes/Estilos/Redmon/jquery-ui-1.7.2.custom.css" type="text/css" rel="stylesheet" />
...
<%--                    <tr>
        ...
        <table width="100%">
            ...
            <tr>
                <td style="width:40%">
                    <asp:UpdatePanel runat="server">
                        <ContentTemplate>
                             <asp:GridView ID="gwvArticuloAsignado" runat="server" 
                                    AutoGenerateColumns="False" DataKeyNames="idItem" 
                                    EmptyDataText="No existe Informacion" 
                                    OnRowCommand="gwvArticuloAsignado_RowCommand" 
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Quitar" ItemStyle-Width="20px">
                                            <ItemTemplate>
                                                <asp:Image ID="imgEditar" runat="server" 
                                                    ImageUrl="~/App_Themes/Imagenes/ico_trashcan.gif" ToolTip="Quitar Registro" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:BoundField DataField="NoSerie" HeaderText="NoSerie" 
            ...
            <tr>
                ...
                <asp:ModalPopupExtender ID="mpeDetalle" runat="server"
                TargetControlID="panelAux"
                CancelControlID="btnRegresar"
                PopupControlID="pnlPopUpDetalle"
                    ...
                    <table class="tablaW">
                        ...
                        <tr>
                            <td colspan="4" align="center">
                                <asp:Button ID="btnRegresar" runat="server" Text="Regresar" CssClass="ui-corner-all ui-state-default cancel" OnClick="btnRegresar_Click" />
                            </td>
                        </tr>
                    </table>
                </ContentTemplate>
    ...
    <div id="Botones" align="center">
         <asp:Button ID="btnSalir" runat="server" 
                    CssClass="ui-corner-all ui-state-default cancel" Text="Salir" 
                    Width="120px" onclick="btnSalir_Click" />
            &nbsp;
                <asp:Button ID="btnGuardar" runat="server" 
                    CssClass="ui-corner-all ui-state-default cancel" Text="Guardar" 
                    Width="120px" onclick="btnGuardar_Click"/>
            &nbsp;
         <asp:Button ID="btnDocumento" runat="server" Text="VerDocumento"
                     CssClass="ui-corner-all ui-state-default cancel" 
