    ...
    j.fn.dataTable = function (g) {
        function l() {
            ...
            this.fnDisplayEnd = function () {
                return this.oFeatures.bServerSide ? this.oFeatures.bPaginate === false || this._iDisplayLength == -1 ? this._iDisplayStart + this.aiDisplay.length : Math.min(this._iDisplayStart + this._iDisplayLength, this._iDisplayStart + this.aiDisplay.length) : this._iDisplayEnd
            };
                ...
                if (f || e || k || !o) {
                    ...
                    for (c = a.aoData.length; b < c; b++) {
                        ...
                        if (f) if (a.aoColumns[h].sType != "string") {
                            ...
                            else if (a.aoColumns[h].sType != s) a.aoColumns[h].sType = "string"
                        }
                        if (e) {
            ...
            for (var c = a.nTableWrapper, d = a.sDom.split(""), f, e, i, h, k, o, t, s = 0; s < d.length; s++) {
                ...
                if (i == "<") {
                    ...
                    if (k == "'" || k == '"') {
                        ...
                        if (o == "H") o = "fg-toolbar ui-toolbar ui-widget-header ui-corner-tl ui-corner-tr ui-helper-clearfix";
                        else if (o == "F") o = "fg-toolbar ui-toolbar ui-widget-header ui-corner-bl ui-corner-br ui-helper-clearfix";
                        h.className = o;
                        s += t
                    }
                    c.appendChild(h);
        ...
        function xa(a) {
            ...
            if (j(a.nTable).outerWidth() < f) if (a.oScroll.sX === "") J(a, 1, "The table cannot fit into the current element which will cause column misalignment. It is suggested that you enable x-scrolling or increase the width the table has in which to be drawn");
        ...
        function P(a, b, c) {
            ...
            for (b = 0; b < a.aoPreSearchCols.length; b++) za(a, a.aoPreSearchCols[b].sSearch, b, a.aoPreSearchCols[b].bRegex, a.aoPreSearchCols[b].bSmart);
        ...
        function Q(a, b) {
            ...
            for (var d = 0, f = b.length; d < f; d++) {
                a.asDataSearch[d] = "";
                for (var e = 0, i = a.aoColumns.length; e < i; e++) if (a.aoColumns[e].bSearchable) a.asDataSearch[d] += ga(a.aoData[b[d]]._aData[e], a.aoColumns[e].sType) + "  ";
                    ...
                    var e = function () {
                        ...
                        if (f.shiftKey) {
                            for (var k = false, o = 0; o < a.aaSorting.length; o++) if (a.aaSorting[o][0] == c) {
                                ...
                                i = a.aaSorting[o][0];
                                h = a.aaSorting[o][2] + 1;
                                if (typeof a.aoColumns[i].asSorting[h] == "undefined") a.aaSorting.splice(o, 1);
                                else {
        ...
        function J(a, b, c) {
            ...
            if (b === 0) if (m.sErrMode == "alert") alert(a);
            else throw a;
        ...
        function ca(a) {
            ...
            var b = [],
                c = [],
                d, f, e, i, h, k, o = function (G, Ma, la) {
        ...
        this.fnGetPosition = function (a) {
            ...
            else if (a.nodeName.toUpperCase() == "TD") for (var c = R(b, a.parentNode), d = 0, f = 0; f < b.aoColumns.length; f++) if (b.aoColumns[f].bVisible) {
        ...
        return this.each(function () {
            ...
            for (b = E.length; a < b; a++) {
                if (E[a].nTable == this) if (typeof g == "undefined" || typeof g.bRetrieve != "undefined" && g.bRetrieve === true) return E[a].oInstance;
            ...
            if (typeof g.aoColumnDefs != "undefined") for (a = g.aoColumnDefs.length - 1; a >= 0; a--) {
                ...
                } else if (typeof k[c] == "number" && k[c] < 0) C(e, e.aoColumns.length + k[c], g.aoColumnDefs[a]);
