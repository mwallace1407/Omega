...
jQuery.validator.addMethod("require_from_group", function(value, element, options) { 
    ...
    if (numberFilled >= numberRequired) { 
		...
		remainingErrors.text("").addClass('checked'); //Tell the Validate plugin that this test passed 
		return true; } //The {0} in the next line is the 0th item in the options array 
    }, jQuery.format("Llena al menos {0} campos"));
