...
namespace InventarioHSC.Forms.Operacion
{
    public partial class Op_Constancias_Carga : System.Web.UI.Page
    {
        ...
        protected string ValidaDetalle(string Linea, int NoLinea)
        {
            ...
            {
                Validaciones += "Encabezado\tEl número de elementos actuales (" + DatosDetalle.Length.ToString() + ") no coincide con la cantidad deseada (" + LongitudDetalle.ToString() + ")." + Environment.NewLine;
            }
