<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CatalogoMarca.aspx.cs"
    MasterPageFile="~/Forms/Main.Master" Title="Catalogo de Marcas" Inherits="InventarioHSC.CatalogoMarca"
        ...
        <div id="space" class="MainDiv">
            ...
            <div style="text-align: left; width: 500px;">
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        <asp:GridView ID="gwvMarca" runat="server" AutoGenerateColumns="False" DataKeyNames="idMarca"
                            Width="500px" EmptyDataText="No existe Informacion" OnRowCommand="gwvMarca_RowCommand"
                            OnRowDataBound="gwvMarca_RowDataBound" AllowPaging="true" OnPageIndexChanging="gwvMarca_PageIndexChanging"
                            PageSize="15">
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="idMarca" HeaderText="ID" SortExpression="idMarca" />
