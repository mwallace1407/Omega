<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CatalogoProveedor.aspx.cs"
    Inherits="InventarioHSC.CatalogoProveedor" EnableEventValidation="false" Title="Catálogo de Proveedores"
        ...
        <div class="MainDiv" id="space">
            ...
            <div style="text-align: left; width: 500px;">
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        <asp:GridView ID="gwvProveedor" runat="server" AutoGenerateColumns="False" DataKeyNames="idProveedor"
                            Width="90%" EmptyDataText="No existe Informacion" OnRowCommand="gwvProveedor_RowCommand"
                            OnRowDataBound="gwvProveedor_RowDataBound" AllowPaging="true" OnPageIndexChanging="gwvProveedor_PageIndexChanging"
                            PageSize="15">
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="idProveedor" HeaderText="ID" SortExpression="idProveedor" />
                                <asp:BoundField DataField="Descripcion" HeaderText="Razón Social" SortExpression="Descripcion" />
                            </Columns>
                        </asp:GridView>
                    </ContentTemplate>
                </asp:UpdatePanel>
