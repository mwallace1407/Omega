<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CatalogoUbicacion.aspx.cs"
    Inherits="InventarioHSC.CatalogoUbicacion" EnableEventValidation="false" Title="Catálogo de Proveedores"
        ...
        <div class="MainDiv" id="space">
            ...
            <div class="MainDiv" style="text-align: left; height: 35px">
                <div style="width: 475px;">
                    ...
                    <div style="width: 400px; float: right">
                        <asp:TextBox runat="server" ID="txtDescripcion" Text="" Width="310px">
                        </asp:TextBox>
                    </div>
                    <br />
                    <div style="width: 75px; float: left">
                    ...
                    <div style="width: 400px; float: right">
                        <asp:DropDownList ID="ddlRegion" runat="server" Height="22px" Width="312px" Style="margin-left: 0px">
                        </asp:DropDownList>
            ...
            <div style="text-align: left; width: 500px;">
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        <asp:GridView ID="gwvUbicacion" runat="server" AutoGenerateColumns="False" DataKeyNames="idUbicacion"
                            Width="90%" EmptyDataText="No existe Informacion" OnRowCommand="gwvUbicacion_RowCommand"
                            OnRowDataBound="gwvUbicacion_RowDataBound" AllowPaging="true" OnPageIndexChanging="gwvUbicacion_PageIndexChanging"
                            PageSize="15">
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="Editar" ItemStyle-Width="20px">
                                    <ItemTemplate>
                                        <asp:Image ID="imgEliminar" runat="server" ToolTip="Editar Registro" ImageUrl="~/App_Themes/Imagenes/ico_trashcan.gif" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:BoundField DataField="idUbicacion" HeaderText="ID" SortExpression="idUbicacion" />
                                <asp:BoundField DataField="descripcion" HeaderText="Nombre de la Ubicación" SortExpression="descripcion" />
                                <asp:BoundField DataField="descRegion" HeaderText="Región" SortExpression="descRegion" />
                            </Columns>
                        </asp:GridView>
                    </ContentTemplate>
                </asp:UpdatePanel>
