...
{
    public partial class RptAsignacionOrganizativa : System.Web.UI.Page
    {
        ...
        protected System.Data.DataTable Fijos()
        {
            ...
            string[] Archivos = System.IO.Directory.GetFiles(Server.MapPath("Fijos"), "AsignacionOrganizativa_*.xlsx");
            System.Data.DataRow dr;

            foreach (string a in Archivos)
            {
                dr = Res.NewRow();
                dr[0] = System.IO.Path.GetFileNameWithoutExtension(a).Replace("AsignacionOrganizativa_", "");
        ...
        protected void btnProcesar_Click(object sender, EventArgs e)
        {
            ...
            //grdDatosF.DataSource = rep.AsignacionOrganizativa(ArmadoCadena(chkEmpleados),
            ...
            exportar.AsignacionOrganizativa((int)DatosGenerales.TiposDocumentos.Reporte_AsignacionOrganizativa, Session["UserNameLogin"].ToString(), Server.MapPath(DatosGenerales.RutaLocalReportesDinamicos), DatosGenerales.GeneraNombreArchivoRnd("RptWSAsigOrg_", "xlsx"), 250000,
