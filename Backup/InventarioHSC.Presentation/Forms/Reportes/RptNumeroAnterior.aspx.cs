...
{
    public partial class RptNumeroAnterior : System.Web.UI.Page
    {
        ...
        protected System.Data.DataTable Fijos()
        {
            ...
            string[] Archivos = System.IO.Directory.GetFiles(Server.MapPath("Fijos"), "NumeroAnterior_*.xlsx");
            System.Data.DataRow dr;

            foreach (string a in Archivos)
            {
                dr = Res.NewRow();
                dr[0] = System.IO.Path.GetFileNameWithoutExtension(a).Replace("NumeroAnterior_", "");
        ...
        protected void btnProcesar_Click(object sender, EventArgs e)
        {
            ...
            //grdDatosF.DataSource = rep.NumeroAnterior(ArmadoCadena(chkEmpleados),
            ...
            exportar.NumAntEmp((int)DatosGenerales.TiposDocumentos.Reporte_NumAntEmp, Session["UserNameLogin"].ToString(), Server.MapPath(DatosGenerales.RutaLocalReportesDinamicos), DatosGenerales.GeneraNombreArchivoRnd("RptWSNumAntEmp_", "xlsx"), 250000,
