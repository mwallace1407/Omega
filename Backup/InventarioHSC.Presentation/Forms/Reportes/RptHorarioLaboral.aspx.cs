...
{
    public partial class RptHorarioLaboral : System.Web.UI.Page
    {
        ...
        protected System.Data.DataTable Fijos()
        {
            ...
            string[] Archivos = System.IO.Directory.GetFiles(Server.MapPath("Fijos"), "HorarioLaboral_*.xlsx");
            System.Data.DataRow dr;

            foreach (string a in Archivos)
            {
                dr = Res.NewRow();
                dr[0] = System.IO.Path.GetFileNameWithoutExtension(a).Replace("HorarioLaboral_", "");
        ...
        protected void btnProcesar_Click(object sender, EventArgs e)
        {
            ...
            //grdDatosF.DataSource = rep.HorarioLaboral(ArmadoCadena(chkEmpleados),
            ...
            exportar.HorariosLaborales((int)DatosGenerales.TiposDocumentos.Reporte_HorariosLaborales, Session["UserNameLogin"].ToString(), Server.MapPath(DatosGenerales.RutaLocalReportesDinamicos), DatosGenerales.GeneraNombreArchivoRnd("RptWSHoraLab_", "xlsx"), 250000,
