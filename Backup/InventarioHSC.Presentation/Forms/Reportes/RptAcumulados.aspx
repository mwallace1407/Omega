                ...
                <ContentTemplate>
                    ...
                    <asp:Panel ID="pnlFiltros" runat="server" Visible="False">
                        ...
                        <div style="width: 360px; height: 100px;">
                            ...
                            <div style="width: 275px; float: right; text-align: left;">
                                <div style="border: 3px ridge SteelBlue; height: 100px; overflow: scroll; overflow-x: hidden;">
                                    <asp:CheckBoxList ID="chkConceptos" runat="server" Width="250" AutoPostBack="True"
                                        OnSelectedIndexChanged="chkConceptos_SelectedIndexChanged">
                                    </asp:CheckBoxList>
                                </div>
                            </div>
                        </div>
                        ...
                        <div style="width: 230px; text-align: left;">
                            <asp:GridView ID="grdDatosF" runat="server" Width="230px" AutoGenerateColumns="False"
