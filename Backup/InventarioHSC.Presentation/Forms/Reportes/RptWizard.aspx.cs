...
{
    public partial class RptWizard : System.Web.UI.Page
    {
        ...
        protected void btnProcesar04_Click(object sender, EventArgs e)
        {
            ...
            if (lblMsjGrid04.Text == "")
            {
                ...
                RD_Id = objRpt.InsertarReporte(txtNombreReporte.Text.Trim(), RDTS_Id, ddlStored.SelectedValue, ddlCnx.SelectedValue, false, Session["UserNameLogin"].ToString());
                ...
                {
                    lblMsjGrid04.Text = "Ya existe un reporte con ese nombre.";
                }
                else
                {
                ...
                if (MsjBD == "OK")
                    DatosGenerales.EnviaMensaje("Proceso finalizado", "Creación de reporte", DatosGenerales.TiposMensaje.Informacion);
                else
        ...
        protected void btnProcesar04Q_Click(object sender, EventArgs e)
        {
            ...
            if (lblMsjGrid04Q.Text == "")
            {
                ...
                RD_Id = objRpt.InsertarReporte(txtNombreReporteQ.Text.Trim(), RDTS_Id, txtScriptPaso04.Text.Trim(), ddlCnx.SelectedValue, false, Session["UserNameLogin"].ToString());
                ...
                {
                    lblMsjGrid04Q.Text = "Ya existe un reporte con ese nombre.";
                }
                else
                {
